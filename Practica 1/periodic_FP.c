...
int main ()
{
  ...
  // Set the priority of thread 1 to min_prio+3
  ...
  // Set the priority of thread 2 to min_prio+2
  sch_param.sched_priority = 
  ...
  // Set the priority of thread 3 to min_prio+4
  sch_param.sched_priority = 
  ...
  // Set the priority of thread 4 to min_prio+5
  sch_param.sched_priority = 
